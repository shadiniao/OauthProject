...
public class GiteeUserInfo {
	...
	public int getTotal_repos() {
		return this.total_repos;
	}

	public void setTotal_repos(int total_repos) {
		this.total_repos = total_repos;
	}

	public int getOwned_repos() {
		return this.owned_repos;
	}

	public void setOwned_repos(int owned_repos) {
